        ...
        <div id="chat-page" :class="chatclass">
            <div class="">
                <div class="row">
                    ...
                    <div class="col-3 ">
                        <h4>Person</h4>
                        <ul class="chat-history" style="padding-bottom: 25px;">
                            <li class=" " v-for="(row, index) in this.chatHistory" key="index"
                                @click="selectItem(index)" style="margin-bottom: 3px; height: 85px;">
                                <div class="row d-flex justify-content-center align-items-center"
                                    style="padding-left: 18px;" :class="{ 'active': index == this.selectedUserIndex }">
                                    <div class="bg-primary"
                                        style="border-radius: 50%; height: 60px; width: 60px; display: flex; justify-content: center; align-items: center;">
                                        <p class="mt-1" style="font-size: 25px; font-style: bold;">PP</p>
                                    </div>
                                    <div class="col d-lg-block d-none mx-3" style="height: 85px;">
                        ...
                        <div class="chat-container">
                            ...
                            <ul id="messageArea">
                                <li v-for="(row, index) in messageList" :key="index"
                                    ...
                                    <span class="rounded-2" @click="liAction"
...
export default {
    ...
    data() {
        return {
            ...
            messageList: [],
            chatProfileName: '',
            chatHistory: ["Ahmet", "Mehmet", "Sancak", "Tepeli", "Ahmet", "Mehmet", "Sancak", "Tepeli", "Ahmet", "Mehmet", "Sancak", "Tepeli", "Ahmet", "Mehmet", "Sancak", "Tepeli", "Ahmet", "Mehmet", "Sancak", "Tepeli"],
